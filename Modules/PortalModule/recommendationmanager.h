...
public:
    ...
    IResponse::Status editRecomm(IRequest *req, uint uid,QString curUser_id, QVariantMap &error);
    IResponse::Status showRecomm(IRequest *req, uint uid,QString curUser_id, QVariantMap &recommendation, QVariantMap &error);
    IResponse::Status deleteRecomm(IRequest *req, uint uid,QString curUser_id, QVariantMap &error);
