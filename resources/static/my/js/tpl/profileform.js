...
buf.push('\n      <input');
buf.push(attrs({ 'type':("text"), 'name':("login"), 'value':("" + (user.login) + ""), 'readonly':(true) }, {"type":true,"name":true,"value":true,"readonly":true}));
buf.push('/>');
__jade.shift();
__jade.unshift({ lineno: 8, filename: __jade[0].filename });
...
buf.push('\n      <input');
buf.push(attrs({ 'type':("text"), 'name':("first_name"), 'value':("" + (user.first_name) + "") }, {"type":true,"name":true,"value":true}));
buf.push('/>');
__jade.shift();
__jade.unshift({ lineno: 13, filename: __jade[0].filename });
buf.push('<span class="help-block">');
...
buf.push('\n      <input');
buf.push(attrs({ 'type':("text"), 'name':("last_name"), 'value':("" + (user.last_name) + "") }, {"type":true,"name":true,"value":true}));
buf.push('/>');
__jade.shift();
__jade.unshift({ lineno: 19, filename: __jade[0].filename });
buf.push('<span class="help-block">');
...
buf.push('\n      <input');
buf.push(attrs({ 'type':("text"), 'name':("email"), 'value':("" + (user.email) + "") }, {"type":true,"name":true,"value":true}));
buf.push('/>');
__jade.shift();
__jade.unshift({ lineno: 25, filename: __jade[0].filename });
buf.push('<span class="help-block">');
