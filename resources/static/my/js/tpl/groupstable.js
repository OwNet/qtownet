...
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 8, filename: __jade[0].filename });
buf.push('created ' + escape((interp = new Date(group.date_created).toLocaleString()) == null ? '' : interp) + '');
__jade.shift();
__jade.shift();
buf.push('</label>');
__jade.shift();
...
buf.push('<a');
buf.push(attrs({ 'href':("#/showgroup"), 'data-id':("" + (group.id) + ""), 'name':("join") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 14, filename: __jade[0].filename });
buf.push('Join group');
...
buf.push('<a');
buf.push(attrs({ 'href':("#/showgroup"), 'data-id':("" + (group.id) + ""), 'name':("edit") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 17, filename: __jade[0].filename });
buf.push('Edit group');
...
buf.push('<a');
buf.push(attrs({ 'href':("#/showgroup"), 'data-id':("" + (group.id) + ""), 'name':("delete") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 18, filename: __jade[0].filename });
