...
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 9, filename: __jade[0].filename });
buf.push('' + escape((interp = user.phone) == null ? '' : interp) + '');
__jade.shift();
__jade.shift();
buf.push('</label>');
__jade.shift();
...
buf.push('<a');
buf.push(attrs({ 'href':("#/editprofile"), 'data-id':("" + (user.id) + ""), 'name':("editprofile") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 11, filename: __jade[0].filename });
...
buf.push('<a href="#" name="showAll">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 12, filename: __jade[0].filename });
buf.push('All Profile');
__jade.shift();
__jade.shift();
buf.push('</a>');
__jade.shift();
