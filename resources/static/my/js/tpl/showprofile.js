...
var __jade = [{ lineno: 1, filename: "templates-client\\showprofile.jade" }];
try {
var buf = [];
with (locals || {}) {
var interp;
...
buf.push('<a');
buf.push(attrs({ 'href':("#"), 'data-id':("" + (user.id) + ""), 'name':("editprofile") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 7, filename: __jade[0].filename });
...
buf.push('<a');
buf.push(attrs({ 'href':("#"), 'data-id':("" + (user.id) + ""), 'name':("deleteprofile") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 9, filename: __jade[0].filename });
buf.push('Delete Profile');
__jade.shift();
__jade.shift();
buf.push('</a>');
__jade.shift();
...
buf.push('<a href="#/profile" name="back">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 13, filename: __jade[0].filename });
buf.push('Go back');
__jade.shift();
