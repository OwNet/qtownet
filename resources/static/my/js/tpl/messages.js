...
var __jade = [{ lineno: 1, filename: "templates-client/messages.jade" }];
try {
var buf = [];
with (locals || {}) {
var interp;
...
buf.push('<a href="#/" name="messages"> <img src="img/message.png" class="icon"> Messages </a>');
__jade.shift();
__jade.shift();
buf.push('</div>');
__jade.shift();
...
buf.push('\n  <div id="create_message" class="span">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</div>');
__jade.shift();
__jade.unshift({ lineno: 10, filename: __jade[0].filename });
buf.push('\n  <div id="messages_list" class="span">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</div>');
__jade.shift();
