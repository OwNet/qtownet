...
var __jade = [{ lineno: 1, filename: "templates-client\\profilepager.jade" }];
try {
var buf = [];
with (locals || {}) {
var interp;
...
__jade.unshift({ lineno: 2, filename: __jade[0].filename });
buf.push('<a');
buf.push(attrs({ 'href':("#/profile"), 'data-id':("" + (page) + ""), 'name':("RecommendationPager") }, {"href":true,"data-id":true,"name":true}));
buf.push('>');
